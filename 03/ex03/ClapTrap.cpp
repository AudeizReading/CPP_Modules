...
/* --- Coplien ------------------------------------------------------------ */
ClapTrap::ClapTrap(std::string const &name, int const &hit, int const &nrg, int const &dmg) : _name(name + "_clap_name"), _hitPoints(hit), _energyPoints(nrg), _attackDamage(dmg) {
