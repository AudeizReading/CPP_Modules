...
ClapTrap::ClapTrap(std::string const &name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) {
	std::cout << *this	<< "have been constructed with default constructor."	<< std::endl;
}
...
ClapTrap::ClapTrap(ClapTrap const &src) : _name(src.getName()), _hitPoints(src.getHitPoints()), _energyPoints(src.getEnergyPoints()), _attackDamage(src.getAttackDamage()) {
	std::cout << *this	<< "have been constructed with copy constructor."	<< std::endl;
}

ClapTrap::~ClapTrap(void) {
	std::cout << *this	<< "have been destructed with destructor."	<< std::endl;
}
...
ClapTrap&		ClapTrap::operator=(ClapTrap const &src) {
	...
	std::cout << *this	<< "have been assigned with assignment operator."	<< std::endl;
	return (*this);
}
/* --- Coplien ------------------------------------------------------------ */
...
void			ClapTrap::takeDamage(unsigned int amount) {
	if (this->isAlive()) {
		...
		std::cout	<< *this << "has taken "	<< amount	<< " life damage"	<< std::endl;
	}
}
